package com.sanghiang.firebasechat.Adapter;
...
import com.sanghiang.firebasechat.R;
...
public class AdapterChatWhatsapp extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public class ItemViewHolder extends RecyclerView.ViewHolder {
        ...
        public TextView text_content, text_username;
        public TextView text_time;
        public View lyt_parent;

        public ItemViewHolder(View v) {
            super(v);
            text_username = v.findViewById(R.id.text_name);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof ItemViewHolder) {
            ...
            vItem.text_username.setText(m.getUsername());
